...
Figure 1(A)
%Simulated data from maize \citep{Wimmer01082012}
%\begin{center}
%\vspace{-0.5cm}
%\includegraphics[width=0.8\linewidth]{SchnabelFigureData_maize}
%\end{center}
%\vspace{-0.2cm}
\end{minipage}
%
...
\begin{minipage}{0.48\textwidth}
 	...
 	In this sense they can serve as a diagnostic tool. 
