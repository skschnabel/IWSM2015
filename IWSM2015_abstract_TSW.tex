...
As a recurring example in this manuscript we are using Chromosome 1 of the above described 
	...
	\textcolor{blue}{$\mu_{\tau}=s_{\tau}(dist)$, where $\mu_\tau$ is the quantile function at percentile $\tau$, $dist$ is the SNP distance between couples of markers and $s_{\tau}(\cdot)$ is a smooth and unknown function.
