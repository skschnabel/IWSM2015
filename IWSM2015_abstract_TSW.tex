...
\abstract{Placeholder for abstract: Genome-wide association studies (GWAS) have emerged as a 
great tool for the localization of QTLs (quantitative trait loci) in plant and animal breeding programs 
...
typically addressed through the use of kinship matrices. Genome-wide association studies 
(GWAS) have emerged as a great tool for the 
localization of QTLs (quantitative trait loci) in plant and animal breeding programs 
with -- maximum length of abstract.}
...
using \texttt{scattersmooth}. (B) Sample of 
